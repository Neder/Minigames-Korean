		...
		if(args != null){
			...
			if(mgm != null){
				...
				if(!mgm.getType().equals("th")){
					...
					if(mgm.isEnabled()){
						lines.add(ChatColor.GRAY + "활성화: " + ChatColor.GREEN + "예");
					}else{
						lines.add(ChatColor.GRAY + "활성화: " + ChatColor.RED + "아니오");
					}
					
					if(mgm.getUsePermissions()){
						lines.add(ChatColor.GRAY + "펄미션 사용: " + ChatColor.GREEN + "예");
					}else{
					...
					if(!mgm.getType().equals("sp")){
						...
						if(mgm.getSpleefFloor1() != null){
							lines.add(ChatColor.GRAY + "바닥 파괴기 위치 1: " + ChatColor.GREEN + "예");
						}
						else{
						...
						if(mgm.getSpleefFloor2() != null){
							lines.add(ChatColor.GRAY + "바닥 파괴기 위치 2: " + ChatColor.GREEN + "예");
						}
						else{
					...
					if(mgm.getRegenArea1() != null){
						lines.add(ChatColor.GRAY + "리젠 지역 위치 1: " + ChatColor.GREEN + "예");
					}
					else{
					...
					if(mgm.getRegenArea2() != null){
						lines.add(ChatColor.GRAY + "리젠 지역 위치 2: " + ChatColor.GREEN + "예");
					}
					else{
					...
					if(mgm.hasDeathDrops()){
						lines.add(ChatColor.GRAY + "죽을 시 아이템 드롭: " + ChatColor.GREEN + "예");
					}else{
						lines.add(ChatColor.GRAY + "죽을 시 아이템 드롭: " + ChatColor.RED + "아니오");
					}
					
					if(mgm.hasItemDrops()){
						lines.add(ChatColor.GRAY + "플레이어 아이템 드롭: " + ChatColor.GREEN + "예");
					}else{
						lines.add(ChatColor.GRAY + "플레이어 아이템 드롭: " + ChatColor.RED + "아니오");
					}
					
					if(mgm.hasItemPickup()){
						lines.add(ChatColor.GRAY + "플레이어 아이템 픽업: " + ChatColor.GREEN + "가능");
					}else{
						lines.add(ChatColor.GRAY + "플레이어 아이템 픽업: " + ChatColor.RED + "불가능");
					}
					
					if(mgm.canBlockBreak()){
						lines.add(ChatColor.GRAY + "블록 부수기: " + ChatColor.GREEN + "가능");
					}else{
						lines.add(ChatColor.GRAY + "블록 부수기: " + ChatColor.RED + "불가능");
					}
					
					if(mgm.canBlockPlace()){
						lines.add(ChatColor.GRAY + "블록 놓기: " + ChatColor.GREEN + "가능");
					}else{
						lines.add(ChatColor.GRAY + "블록 놓기: " + ChatColor.RED + "불가능");
					}
					
					if(mgm.canBlocksdrop()){
						lines.add(ChatColor.GRAY + "블록이 아이템 드롭: " + ChatColor.GREEN + "드롭함");
					}else{
						lines.add(ChatColor.GRAY + "블록이 아이템 드롭: " + ChatColor.RED + "드롭 안함");
					}
					...
					if(mgm.getSecondaryRewardItem() != null){
						lines.add(ChatColor.GRAY + "두 번째 아이템 보상: " + ChatColor.GREEN + MinigameUtils.getItemStackName(mgm.getSecondaryRewardItem()) + "(" + mgm.getSecondaryRewardItem().getAmount() + " 개)");
					}else{
						lines.add(ChatColor.GRAY + "두 번째 아이템 보상: " + ChatColor.RED + "설정되지 않음");
					}
					
					if(mgm.getSecondaryRewardPrice() != 0){
						lines.add(ChatColor.GRAY + "두 번째 돈 보상: " + ChatColor.GREEN + mgm.getSecondaryRewardPrice() + "원");
					}
					else{
						lines.add(ChatColor.GRAY + "두 번째 돈 보상: " + ChatColor.RED + "설정되지 않음");
					}
					...
					if(mgm.hasPaintBallMode()){
						lines.add(ChatColor.GRAY + "페인트볼 모드: " + ChatColor.GREEN + "예");
					...
					if(mgm.hasUnlimitedAmmo()){
						lines.add(ChatColor.GRAY + "무한 총알: " + ChatColor.GREEN + "예");
					}
					else{
					...
					if(mgm.isAllowedEnderpearls()) {
						lines.add(ChatColor.GRAY + "엔더 진주 사용 여부:" + ChatColor.GREEN + "예");
					}
					else {
					...
					if(mgm.getType().equals("sp")){
						if(mgm.canSaveCheckpoint()){
							lines.add(ChatColor.GRAY + "체크포인트 저장: " + ChatColor.GREEN + "예");
						}
						else{
						...
						if(mgm.canLateJoin()){
							lines.add(ChatColor.GRAY + "게임 중에 참가: " + ChatColor.GREEN + "가능");
						}
						else{
							lines.add(ChatColor.GRAY + "게임 중에 참가: " + ChatColor.RED + "불가능");
						}
					}
					
					if(mgm.isRandomizeChests()){
						lines.add(ChatColor.GRAY + "랜덤 체스트: " + ChatColor.GREEN + "예");
					}
					else{
