...
public class HelpCommand implements ICommand{
	...
	public String getPermissionMessage() {
		return "당신은 도움말 명령어를 사용할 권한이 없습니다!";
	}
	...
	public boolean onCommand(CommandSender sender, Minigame minigame,
		...
		sender.sendMessage(ChatColor.GREEN + "미니게임 명령어 목록");
		sender.sendMessage(ChatColor.BLUE + "/minigame");
		sender.sendMessage(ChatColor.GRAY + "기본 명령어 (단축 명령어: /mg)");
		...
		if(player == null || player.hasPermission("minigame.quit")){
			...
			if(player == null || player.hasPermission("minigame.quit.other")){
				sender.sendMessage("다른 플레이어도 나가게 할 수 있습니다.");
			}
		}
		...
		if(player == null || player.hasPermission("minigame.revert")){
			...
			sender.sendMessage("체크포인트로 돌아갑니다. (줄임 명령어: /mg r)");
		}
		...
		sender.sendMessage(ChatColor.BLUE + "/minigame set <미니게임> <옵션>...");
		sender.sendMessage("미니게임을 설정합니다. /minigame set 으로 옵션 목록을 볼 수 있습니다.");
		return true;
	}
